...
class GensNulsController extends AbstractController
{
    /**
     * @Route("gens-nuls", name="gens_nuls")
     */
    ...
    public function gens()
    {
        ...
        return $this->render('gens_nuls.html.twig', [
            'categories' => $categories
        ]);
    }

        /**
         * @Route("/gens-nul/{id}", name="gens_nul")
         */

        public function show_gens ($id){
            ...
            return $this->render('gens_nul.html.twig', [
                'show_zebi' => $show_zebi[$id]
            ]);
        }
